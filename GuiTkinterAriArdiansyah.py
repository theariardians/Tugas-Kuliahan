...
lbl11 = Label(window, text="HASIL", bg="white", fg="black", anchor="e", width=20 )
lbl11.grid(row=11, column=1, columnspan=2)
lbl12 = Label(window, text="NAMA :", bg="white", fg="black", anchor="e", width=20)
lbl12.grid(row=12, column=1)
lbl13 = Label(window, text="NIM :", bg="white", fg="black", anchor="e", width=20)
lbl13.grid(row=13, column=1)
lbl7 = Label(window, text="JUMLAH NILAI :", bg="white", fg="black", anchor="e", width=20)
lbl7.grid(row=14, column=1)
lbl8 = Label(window, text="RATA-RATA :", bg="white", fg="black", anchor="e", width=20)
lbl8.grid(row=15, column=1)
lbl9 = Label(window, text="GRADE :", bg="white", fg="black", anchor="e", width=20)
lbl9.grid(row=16, column=1)
lbl10 = Label(window, text="KETERANGAN :", bg="white", fg="black", anchor="e", width=20)
lbl10.grid(row=17, column=1)
